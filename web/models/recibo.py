...
pdf.criar_recibo(
    ...
    tabela_valores=[
        ...
        ("OUTROS DESCONTOS EM FOLHA", "", "", str(resultado_consulta[1])),
        ("HORAS EXTRAS À 50%", "", "", str(resultado_consulta[1])),
        ("DSR 50%", "", "", str(resultado_consulta[1])),
        ("HORAS EXTRAS À 65%", "", "", str(resultado_consulta[1])),
        ("DSR 65%", "", "", str(resultado_consulta[1])),
        ("HORAS EXTRAS À 75%", "", "", str(resultado_consulta[1])),
